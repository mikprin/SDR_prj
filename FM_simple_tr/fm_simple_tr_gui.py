...
class fm_simple_tr_gui(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_short*1, 'file_example_MP3_700KB.mp3', True, 0, 0)
        ...
        self.connect((self.blocks_short_to_float_0, 0), (self.analog_wfm_tx_0, 0))
