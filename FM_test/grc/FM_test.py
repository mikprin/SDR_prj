...
class FM_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.osmosdr_source_0.set_center_freq(center_freq_0, 0)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_COS_WAVE, center_freq_0 - ch_freq, 1, 0, 0)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 65e3, 25e3, window.WIN_HAMMING, 6.76))
    ...
    def set_ch_freq(self, ch_freq):
        ...
        self.analog_sig_source_x_0.set_frequency(self.center_freq_0 - self.ch_freq)
        self.qtgui_freq_sink_x_0_0.set_frequency_range(self.ch_freq, self.bandwidth_0)
    ...
    def set_center_freq_0(self, center_freq_0):
        ...
        self.analog_sig_source_x_0.set_frequency(self.center_freq_0 - self.ch_freq)
        self.osmosdr_source_0.set_center_freq(self.center_freq_0, 0)
        self.qtgui_freq_sink_x_0.set_frequency_range(self.center_freq_0, self.bandwidth_0)
